...
class DisplayDevice{
    ...
    public void current(){
       var temp= "The current temperature is: " + listTemperature.get(listTemperature.size()-1);
       var press= "The current pressure is: " + listPressure.get(listPressure.size()-1);
       var hum= "The current humidity is: " + listHumidity.get(listHumidity.size()-1);
       logger.info(temp);
       logger.info(press);
       logger.info(hum);
    }
    ...
    public void mean(){
        ...
        var temp="the mean of temperature is: " + sumt/listTemperature.size();
        var pres="the mean of pressure is: " + pre/listTemperature.size();
        var humi="the mean of humidity is: " + hum/listTemperature.size();
        logger.info(temp);
        logger.info(pres);
        logger.info(humi);
    }
